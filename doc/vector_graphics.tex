...
\noindent {\tt box from Dx,Dy to Cx,Cy with fillcol grey50}\newline
\noindent {\tt box at Ax,Ay width AC height AC rot CBA-90*unit(deg) with fillcol grey50}\newline
\noindent {\tt box at Bx,By width AB height AB rot CBA with fillcol grey50}\newline
