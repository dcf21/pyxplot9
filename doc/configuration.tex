...
{\tt binOrigin} & {\bf Possible values:} Any floating-point number.
               ...
               \\
{\tt autoBinOrigin} & {\bf Possible values:} {\tt on}, {\tt off}.

               {\bf Analogous set command:} {\tt set binorigin}

               Sets the point along the abscissa axis from which the bins used by the \indcmdt{histogram} originate to be chosen automatically.
               \\
{\tt binWidth} & {\bf Possible values:} Any floating-point number.
               ...
               \\
{\tt autoBinWidth} & {\bf Possible values:} {\tt on}, {\tt off}.

               {\bf Analogous set command:} {\tt set binwidth}

               Sets the widths of the bins used by the \indcmdt{histogram} to be chosen automatically.
               \\
{\tt boxFrom} & {\bf Possible values:} Any floating-point number.
               ...
               \\
{\tt autoBoxFrom} & {\bf Possible values:} {\tt on}, {\tt off}.

               {\bf Analogous set command:} {\tt set boxfrom}

               Sets the horizontal point from which bars on bar charts appear to emanate to be chosen automatically.
               \\
{\tt boxWidth} & {\bf Possible values:} Any floating-point number.
               ...
               \\
{\tt autoBoxWidth} & {\bf Possible values:} {\tt on}, {\tt off}.

               {\bf Analogous set command:} {\tt set boxwidth}

               Sets the boxes on barcharts to have automatically-selected widths.
               \\
...
{\tt gridAxisZ} & {\bf Possible values:} Any integer.
               ...
               \\
{\tt gridMajColour} & {\bf Possible values:} Any recognised color.

               {\bf Analogous set command:} \indcmdts{set gridmajcolor}

               Sets the color of major grid lines.
               \\
{\tt gridMinColour} & {\bf Possible values:} Any recognised color.
