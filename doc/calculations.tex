...
defined in modules. For example, the speed of light is defined in the module
{\tt phy}:
...
dates into elapsed times between the \datapoint s.  Months have non-uniform
...
The time interval between two date objects can be found by subtracting the two
objects, as demonstrated in the following example which calculates the interval
between Albert Einstein's birth and death. The result is returned as a
numerical object with physical dimensions of time:
