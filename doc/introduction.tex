...
ellipses can be drawn to build vector graphics. Colors are a native type of
object for easy customisation. For the mathematically minded, Pyxplot's canvas
...
This section provide an overview of the wide range of tasks for which Pyxplot
