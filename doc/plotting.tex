...
overview of the \indcmdt{plot} given in Chapter~\ref{ch:first_steps}.
...
centered upon their specified $x$-coordinates, and have total widths equalling
...
\indpst{histeps} plot style centers each step upon the \datapoint\ it
represents.
...
length might be displayed in millimeters, meters or kilometers depending upon
their scales.
