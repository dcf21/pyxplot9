...
The default mapping used between values of $c$ and color is a greyscale
...
\indcmdt{set colormap}, which takes algebraic expressions for the RGB, HSB or
...
range are clipped.  The syntax of the \indcmdt{set colormap} is as follows:
